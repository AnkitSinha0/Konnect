...
echo " Local .env files (should exist but be git-ignored):"
find . -name ".env" -not -name "*.example" | grep -v node_modules
echo "  These files should exist locally but be ignored by git"
echo ""

# Verify .env files are ignored
echo " Verifying .env files are git-ignored:"
...
echo " Files that will be committed (staged and untracked):"
echo " Staged files:"
...
echo " Checking for potential hardcoded credentials in files to be committed:"
...
echo " Verifying .gitignore files exist:"
